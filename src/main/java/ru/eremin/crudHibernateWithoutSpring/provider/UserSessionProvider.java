...
public class UserSessionProvider implements SessionProvider {
    ...
    public SessionFactory getSessionFactory() {
        ...
        hibernateProperties.setProperty("hibernate.connection.driver_class", DRIVER_POSTGRESQL);
        ...
        hibernateProperties.setProperty("hibernate.dialect", DIALECT_POSTGRESQL);
